 ...
 */
class Comentari extends \App\Entity\Comentari implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Comentari' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Comentari' . "\0" . 'tipus', '' . "\0" . 'App\\Entity\\Comentari' . "\0" . 'text', '' . "\0" . 'App\\Entity\\Comentari' . "\0" . 'user', '' . "\0" . 'App\\Entity\\Comentari' . "\0" . 'article', '' . "\0" . 'App\\Entity\\Comentari' . "\0" . 'dataPublicacio', '' . "\0" . 'App\\Entity\\Comentari' . "\0" . 'visible'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Comentari $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setTipus(string $tipus): \App\Entity\Comentari
    {
     ...
     * {@inheritDoc}
     */
    public function setText(string $text): \App\Entity\Comentari
    {
     ...
     * {@inheritDoc}
     */
    public function setUser(?\App\Entity\User $user): \App\Entity\Comentari
    {
     ...
     * {@inheritDoc}
     */
    public function setArticle(?\App\Entity\Article $article): \App\Entity\Comentari
    {
     ...
     * {@inheritDoc}
     */
    public function setDataPublicacio(\DateTimeInterface $dataPublicacio): \App\Entity\Comentari
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setDataPublicacio', [$dataPublicacio]);

        return parent::setDataPublicacio($dataPublicacio);
    }
     ...
     * {@inheritDoc}
     */
    public function setVisible(bool $visible): \App\Entity\Comentari
    {
